<x-app>
    ...
    <div class="card shadow-lg p-3">
        ...
        <form action="{{ route('patient.update', $patient) }}" method="post" class="form">
            @csrf
            @method('put')
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        <label for="medical_record_number" class="form-label">No. Rekam Medis</label>
                        <input class="form-control" type="text" id="medical_record_number"
                            value="{{ $patient->medical_record_number }}" disabled readonly>
                    </div>

                    <div class="mb-3">
                        <label for="name" class="form-label required">Nama</label>
                        <input class="form-control @error('name') is-invalid  @enderror" type="text" id="name"
                            name="name" required value="{{ old('name', $patient->name) }}">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('nik') is-invalid  @enderror" type="text" id="nik"
                            name="nik" required value="{{ old('nik', $patient->nik) }}" maxlength="16" minlength="16">
                        @error('nik')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('date_of_birth') is-invalid  @enderror" type="date" id="date_of_birth"
                            name="date_of_birth" required value="{{ old('date_of_birth', $patient->date_of_birth) }}">
                        @error('date_of_birth')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('gender') is-invalid  @enderror" id="gender"
                            ...
                            <option value="M" @selected(old('gender', $patient->gender) == 'M')>Laki-laki</option>
                            <option value="F" @selected(old('gender', $patient->gender) == 'F')>Perempuan</option>
                        </select>
                        @error('gender')
                            <div class="invalid-feedback">
                                {{ $message }}
