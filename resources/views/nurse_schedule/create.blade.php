<x-app>
    ...
    <div class="card shadow-lg p-3">
        <form action="{{ route('nurse-schedule.store') }}" method="post" class="form">
            @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('shift') is-invalid @enderror" id="shift" name="shift" required>
                        ...
                        <option value="Pagi" @selected(old('shift') == 'Pagi')>Pagi (07:00 - 15:00)</option>
                        <option value="Sore" @selected(old('shift') == 'Sore')>Sore (15:00 - 22:00)</option>
                        <option value="Malam" @selected(old('shift') == 'Malam')>Malam (22:00 - 07:00)</option>
                    </select>
                    @error('shift')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
